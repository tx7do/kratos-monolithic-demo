...
type LoginRequest struct {
	...
	GrandType string  `protobuf:"bytes,3,opt,name=grandType,json=grand_type,proto3" json:"grandType,omitempty"` // 授权类型，此处的值固定为"password"，必选项。
...
type LoginResponse struct {
	...
	AccessToken  string `protobuf:"bytes,1,opt,name=accessToken,json=access_token,proto3" json:"accessToken,omitempty"`    // 访问令牌，必选项。
	RefreshToken string `protobuf:"bytes,2,opt,name=refreshToken,json=refresh_token,proto3" json:"refreshToken,omitempty"` // 更新令牌，用来获取下一次的访问令牌，可选项。
	TokenType    string `protobuf:"bytes,3,opt,name=tokenType,json=token_type,proto3" json:"tokenType,omitempty"`          // 令牌类型，该值大小写不敏感，必选项，可以是bearer类型或mac类型。
	ExpiresIn    int64  `protobuf:"varint,4,opt,name=expiresIn,json=expires_in,proto3" json:"expiresIn,omitempty"`         // 过期时间，单位为秒。如果省略该参数，必须其他方式设置过期时间。
}
...
type RefreshTokenRequest struct {
	...
	RefreshToken string  `protobuf:"bytes,1,opt,name=refreshToken,json=refresh_token,proto3" json:"refreshToken,omitempty"` // 更新令牌，用来获取下一次的访问令牌，必选项。
	GrandType    string  `protobuf:"bytes,2,opt,name=grandType,json=grand_type,proto3" json:"grandType,omitempty"`          // 授权类型，此处的值固定为"password"，必选项。
...
type RefreshTokenResponse struct {
	...
	RefreshToken string `protobuf:"bytes,1,opt,name=refreshToken,json=refresh_token,proto3" json:"refreshToken,omitempty"` // 更新令牌，用来获取下一次的访问令牌，可选项。
	GrandType    string `protobuf:"bytes,2,opt,name=grandType,json=grand_type,proto3" json:"grandType,omitempty"`          // 授权类型，此处的值固定为"password"，必选项。
}
...
var file_admin_service_v1_i_authentication_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xee, 0x01, 0x0a, 0x0c, 0x4c, 0x6f,
	...
	0x41, 0x02, 0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x72, 0x0a, 0x09,
	0x67, 0x72, 0x61, 0x6e, 0x64, 0x54, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x42,
	...
	0x12, 0x1e, 0x0a, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x42,
	0x03, 0xe0, 0x41, 0x01, 0x48, 0x00, 0x52, 0x05, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x88, 0x01, 0x01,
	0x42, 0x08, 0x0a, 0x06, 0x5f, 0x73, 0x63, 0x6f, 0x70, 0x65, 0x22, 0x95, 0x01, 0x0a, 0x0d, 0x4c,
	0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x21, 0x0a, 0x0b,
	...
	0x23, 0x0a, 0x0c, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x74,
	0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1d, 0x0a, 0x09, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x54, 0x79, 0x70,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x74,
	0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x09, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x49, 0x6e,
	0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x65, 0x78, 0x70, 0x69, 0x72, 0x65, 0x73, 0x5f,
	0x69, 0x6e, 0x22, 0x1f, 0x0a, 0x0d, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x52, 0x65, 0x71, 0x75,
	...
	,
	...
	0x7d, 0x0a, 0x06, 0x4c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x12, 0x1f, 0x2e, 0x61, 0x64, 0x6d, 0x69,
	...
	0x74, 0x79, 0x22, 0x3a, 0xba, 0x47, 0x1c, 0x5a, 0x1a, 0x0a, 0x18, 0x0a, 0x14, 0x4f, 0x41, 0x75,
	0x74, 0x68, 0x32, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x42, 0x65, 0x61, 0x72, 0x65,
	0x72, 0x12, 0x00, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x15, 0x3a, 0x01, 0x2a, 0x22, 0x10, 0x2f, 0x61,
	0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x76, 0x31, 0x2f, 0x6c, 0x6f, 0x67, 0x6f, 0x75, 0x74, 0x12, 0x99,
	...
	0x42, 0x65, 0x61, 0x72, 0x65, 0x72, 0x12, 0x00, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x1c, 0x3a, 0x01,
	0x2a, 0x22, 0x17, 0x2f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x76, 0x31, 0x2f, 0x72, 0x65, 0x66,
	0x72, 0x65, 0x73, 0x68, 0x5f, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x73, 0x0a, 0x05, 0x47, 0x65,
	0x74, 0x4d, 0x65, 0x12, 0x1e, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x22, 0x33, 0xba, 0x47, 0x1c, 0x5a,
	...
	0x0e, 0x12, 0x0c, 0x2f, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x76, 0x31, 0x2f, 0x6d, 0x65, 0x42,
	0xcc, 0x01, 0x0a, 0x14, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x64, 0x6d, 0x69, 0x6e, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x42, 0x14, 0x49, 0x41, 0x75, 0x74, 0x68, 0x65,
